...
local OrionLib = {
	...
	Themes = {
		Default = {
			...
			Stroke = Color3.fromRGB(50, 205, 50),
...
if not Success then
	warn("\nHebi Client Hub - Failed to load Feather Icons. Error code: " .. Response .. "\n")
end	
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if OrionLib.Flags[a] then
			...
			warn("Hebi Client Hub Config Loader - Could not find ", a ,b)
		end
	end)
end
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Hebi Client Hub"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Hebi Client Hub"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://14340015844"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://14340015844"
